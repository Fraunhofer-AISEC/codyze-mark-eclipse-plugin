...
public class XtextParserTest {
	...
	public void test() {
		...
		EObject result = parser.parse(new File("/home/julian/workspace/2018-11-bsi-secure-crypto-lib-tool/code/mark-crymlin-eclipse-plugin/examples/Test/Rules.mark"));
