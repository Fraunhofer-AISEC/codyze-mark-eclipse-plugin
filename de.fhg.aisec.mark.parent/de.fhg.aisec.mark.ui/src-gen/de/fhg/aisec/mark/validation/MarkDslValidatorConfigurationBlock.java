 ...
 */
package de.fhg.aisec.mark.validation;
...
public class MarkDslValidatorConfigurationBlock extends AbstractValidatorConfigurationBlock {

	@Override
	protected void fillSettingsPage(Composite composite, int nColumns, int defaultIndent) {
		addComboBox(MarkDslConfigurableIssueCodesProvider.DEPRECATED_MODEL_PART, "Deprecated Model Part", composite, defaultIndent);
	}
	...
	protected IDialogSettings getDialogSettings() {
		...
		IDialogSettings section = dialogSettings.getSection("MarkDsl");
		if (section == null) {
			return dialogSettings.addNewSection("MarkDsl");
		}
		return section;
	}
}
